  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.searchBar}>
        ...
        />
        <button onClick={handleBuscarClick}>Buscar Especialidade</button>
      </div>
          ...
          <ul>
            {filteredEspecialidades.map((especialidade) => (
              <li
                ...
                onClick={() => handleSelectEspecialidade(especialidade.nome)}
              >
                {especialidade.nome}
              </li>
            ))}
      ...
      {selectedEspecialidade && (
        <div className={styles.selectedEspecialidade}>
          <h3>Especialidade Selecionada: {selectedEspecialidade}</h3>
        </div>
      )}
